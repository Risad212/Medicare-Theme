        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="about-image">
                    <div class="circle">
                        <img src="<?php echo esc_url($about_page_circle_image); ?>" alt="Circle Image">
                    </div>
                    <div class="first-img">
                        <img class="img-fluid" src="<?php echo esc_url( $about_page_small_image) ?>" alt="Small Image">
                    </div>
                    <div class="second-img">
                        <img class="img-fluid" src="<?php echo esc_url( $about_page_large_image) ?>" alt="Large Image">
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="about-content">
                    <h6 class="subtitle"><?php echo esc_html($about_page_subtitle); ?></h6>
                    <h2 class="title"><?php echo esc_html($about_page_title); ?></h2>
                    <p><?php echo esc_html($about_page_disc); ?></p>
                    <button class="about-btn">
                        <a href="<?php echo esc_url( $about_btn_link); ?>"><?php echo esc_html($about_btn_text); ?></a>
